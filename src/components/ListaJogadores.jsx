...
const ListaJogadores = ({ height, nodes }) => {
    ...
    return (
        <>
            ...
            <div style={{ height: height, overflowY: 'scroll' }} className="card-body">
                {nodes.map((squad) => (
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">
                                ...
                                {squad.name} <span class="badge bg-success"> {squad.position ? squad.position.toUpperCase() : null }</span>
                            </h6>
